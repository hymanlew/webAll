 ...
 * 
 */
@WebServiceClient(name = "CollectionWSService", targetNamespace = "http://webserviceDemo/", wsdlLocation = "http://127.0.0.1/collection?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COLLECTIONWSSERVICE_QNAME = new QName("http://webserviceDemo/", "CollectionWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1/collection?wsdl");
    ...
    public CollectionWS getCollectionWSPort() {
        return super.getPort(new QName("http://webserviceDemo/", "CollectionWSPort"), CollectionWS.class);
    }
    ...
    public CollectionWS getCollectionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webserviceDemo/", "CollectionWSPort"), CollectionWS.class, features);
    }
